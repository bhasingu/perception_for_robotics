...
# OPTIONS
###########################################################
def yolo(sample_name, image_path, output_dir):
    yolo_dir = 'yolo'
    ...
    idxs = cv2.dnn.NMSBoxes(boxes, confidences, confidence_th,
                            threshold)
    # print("idxs for image: " + sample_name)
    # print(idxs)
    # print("classIDs for image: " + sample_name)
    # print(classIDs)
    ...
    # print("boxes for image: " + sample_name)
    # print(boxes)
    # cv2.imshow("Image", image)
    # cv2.waitKey(0)
    cv2.imwrite(output_dir + '/bounding_box_' + sample_name + '.jpg',image)
    return idxs, classIDs, boxes
...
for sample_name in (sample_list_train):
    ...
    output_dir_train = 'data/train/bounding_box'
    idxs, classIDs, boxes = yolo(sample_name, image_path_train, output_dir_train)
for sample_name in (sample_list_test):
    image_path_test = 'data/test/left/' + sample_name + '.png'
    output_dir_test = 'data/test/bounding_box'
    idxs, classIDs, boxes = yolo(sample_name, image_path_test, output_dir_test)                    